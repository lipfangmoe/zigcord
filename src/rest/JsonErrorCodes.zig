...
pub const ErrorCode = enum(u64) {
    ...
    the_write_action_you_are_performing_on_the_channel_has_hit_the_write_rate_limit = 20028,
    ...
    you_cannot_forward_a_message_whose_content_you_cannot_read = 160014,
