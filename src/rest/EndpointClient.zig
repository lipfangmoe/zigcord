...
pub const getGuildScheuledEvent = guild_scheduled_event.getGuildScheuledEvent;
...
pub const getGuildScheuledEventUsers = guild_scheduled_event.getGuildScheuledEventUsers;
