...
pub const AttachmentRequest = channel.AttachmentRequest;
pub const bulkDeleteMessages = channel.bulkDeleteMessages;
pub const createChannelInvite = channel.createChannelInvite;
pub const CreateChannelInviteFormBody = channel.CreateChannelInviteFormBody;
pub const CreateChannelInviteJsonBody = channel.CreateChannelInviteJsonBody;
pub const createChannelInviteMultipart = channel.createChannelInviteMultipart;
...
pub const PartialAttachmentRequest = channel.PartialAttachmentRequest;
...
pub const setVoiceChannelStatus = channel.setVoiceChannelStatus;
pub const SetVoiceChannelStatusBody = channel.SetVoiceChannelStatusBody;
...
pub const searchGuildMessages = guild.searchGuildMessages;
pub const SearchGuildMessagesQueryParams = guild.SearchGuildMessagesQueryParams;
...
pub const getTargetUsers = invite.getTargetUsers;
pub const getTargetUsersJobStatus = invite.getTargetUsersJobStatus;
pub const GetTargetUsersResponse = invite.GetTargetUsersResponse;
pub const JobStatus = invite.JobStatus;
pub const updateTargetUsers = invite.updateTargetUsers;
pub const UpdateTargetUsersFormBody = invite.UpdateTargetUsersFormBody;
pub const UsersIterator = invite.UsersIterator;
pub const lobby = @import("./endpoints/lobby.zig");
pub const addAMemberToALobby = lobby.addAMemberToALobby;
pub const AddAMemberToALobbyBody = lobby.AddAMemberToALobbyBody;
pub const BulkUpdateLobbyMember = lobby.BulkUpdateLobbyMember;
pub const bulkUpdateLobbyMembers = lobby.bulkUpdateLobbyMembers;
pub const createLobby = lobby.createLobby;
pub const CreateLobbyBody = lobby.CreateLobbyBody;
pub const createOrJoinLobby = lobby.createOrJoinLobby;
pub const CreateOrJoinLobbyBody = lobby.CreateOrJoinLobbyBody;
pub const deleteAMemberFromALobby = lobby.deleteAMemberFromALobby;
pub const deleteLobby = lobby.deleteLobby;
pub const getLobby = lobby.getLobby;
pub const leaveLobby = lobby.leaveLobby;
pub const linkChannelToLobby = lobby.linkChannelToLobby;
pub const modifyLobby = lobby.modifyLobby;
pub const ModifyLobbyBody = lobby.ModifyLobbyBody;
