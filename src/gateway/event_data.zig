...
pub const ReceiveEventData = union(enum) {
    ...
    channel_info: receive_events.ChannelInfo,
    voice_channel_status_update: receive_events.VoiceChannelStatusUpdate,
    voice_channel_start_time_update: receive_events.VoiceChannelStartTimeUpdate,
